...
var $export     = __webpack_require__(0)
  , $parseFloat = __webpack_require__(98);
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(11)(proto, TO_PRIMITIVE, __webpack_require__(202));
...
var _presentation = __webpack_require__(303);
...
deck.on('activate', function (e) {
	if (e.slide.id.indexOf('demo-') !== -1) {
		var _e$slide$id$split = e.slide.id.split('-'),
		    _e$slide$id$split2 = _slicedToArray(_e$slide$id$split, 2),
		    type = _e$slide$id$split2[1];

		(0, _common2.default)('#chart-' + type, charts[type], d3.select('#chart-' + type).node().dataset);
	}
});

deck.on('deactivate', function () {
	[].concat(_toConsumableArray(document.querySelectorAll('svg'))).forEach(function (chart) {
		return chart.remove();
	});
});
			...
			while (1) {
				switch (_context.prev = _context.next) {
					...
					case 4:
						...
						pieData = pie(Object.entries(byGender)).sort(function (a, b) {
							return b.data[1] - a.data[1];
						});

						color.domain(pieData.map(function (d) {
							return d.data[0];
						}));
...
var stack = exports.stack = function () {
	var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
		var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { wiggle: true };
		var color = arguments[1];

		var _ref3, data, episodesPerSeason, totalSeasons, _svg$node, height, width, seasons, stack, x, y, area, streams;
		...
		return regeneratorRuntime.wrap(function _callee2$(_context2) {
			while (1) {
				switch (_context2.prev = _context2.next) {
					case 0:
						_context2.next = 2;
						return fetch('data/deaths-by-season.json');
					...
					case 4:
						...
						seasons = d3.nest().key(function (d) {
							...
							return d.death.season;
						}).entries(data.filter(function (d) {
							return !d.death.isFlashback;
						})).map(function (v) {
							return d3.range(1, totalSeasons + 1).reduce(function (item, episodeNumber) {
								var deaths = v.values.filter(function (d) {
									return Number(d.key) === episodeNumber;
								}).shift() || 0;
						...
						}), d3.max(stack(seasons), function (d) {
...
var tree = exports.tree = function () {
	var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(opts, color) {
		var data, _svg$node2, height, width, chart, stratify, root, layout, line, links, node;
		...
		return regeneratorRuntime.wrap(function _callee3$(_context3) {
			while (1) {
				switch (_context3.prev = _context3.next) {
					case 0:
						_context3.next = 2;
						return fetch('data/got-lineages.json');
...
var force = exports.force = function () {
	var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(opts, color) {
		var data, _svg$node3, height, width, link, radius, node, padding, sim, ticked, dragstart, dragging, dragend;
			...
			while (1) {
				switch (_context4.prev = _context4.next) {
					case 0:
						...
						_context4.next = 6;
						return fetch('data/network-of-thrones.json');
...
var treemap = exports.treemap = function () {
	var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(opts, color) {
		var data, _svg$node4, height, width, stratify, root, cellPadding, layout, nodes;
		...
		return regeneratorRuntime.wrap(function _callee5$(_context5) {
			while (1) {
				switch (_context5.prev = _context5.next) {
					case 0:
						_context5.next = 2;
						return fetch('data/lineages-screentimes.json');
	...
	return function treemap(_x8, _x9) {
...
var pack = exports.pack = function () {
	var _ref7 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(opts, color) {
		var data, _svg$node5, height, width, stratify, root, layout, nodes;
				...
				switch (_context6.prev = _context6.next) {
					...
					case 4:
						...
						nodes = this.container.selectAll('.node').data(root.descendants().slice(1)).enter().append('circle').attr('class', 'node').attr('cx', function (d) {
							...
							return d3.color(color(d.data.house)).darker();
						}).attr('fill', function (d) {
							return color(d.data.house);
						});
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js??ref--1-1!./prism-funky.css", function() {
			var newContent = require("!!../../css-loader/index.js??ref--1-1!./prism-funky.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../css-loader/index.js??ref--1-1!./prism-line-numbers.css", function() {
			var newContent = require("!!../../../css-loader/index.js??ref--1-1!./prism-line-numbers.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../css-loader/index.js??ref--1-1!./prism-line-highlight.css", function() {
			var newContent = require("!!../../../css-loader/index.js??ref--1-1!./prism-line-highlight.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
