...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js??ref--2-1!./prism-funky.css", function() {
			var newContent = require("!!../../css-loader/index.js??ref--2-1!./prism-funky.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../css-loader/index.js??ref--2-1!./prism-line-numbers.css", function() {
			var newContent = require("!!../../../css-loader/index.js??ref--2-1!./prism-line-numbers.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../css-loader/index.js??ref--2-1!./prism-line-highlight.css", function() {
			var newContent = require("!!../../../css-loader/index.js??ref--2-1!./prism-line-highlight.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
